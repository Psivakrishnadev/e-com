    ...
    <section class="section-padding bg-dark inner-header" style="background-image: url('assets/images/banner-image/4.jpg');height: 250px;" >
	  ...
	  <div class="page-content bg-white">
        ...
        <div class="content-block">
            <br/>
            <h2 style="text-align:center">My Used PINs
</h2>	
            <br/>
            <br/><!-- Browse Jobs -->
...
<tr>
 <td><b>PIN</b>
 <td><b>Activated For</b>
</tr>

<tr>
 <td colspan=2 align=center><div class='row'><div class='col-lg-12'><a href='#' class='pagi-btn'>1</a> </div></div></tr>
 </table>
							</div>
							<!-- Modal -->
