...
*/            
    ...
    <section class="section-padding bg-dark inner-header" style="background-image: url('assets/images/banner-image/4.jpg');height: 250px;" >
	  ...
	  <div class="page-content bg-white">
        ...
        <div class="content-block">
            <br/>
            <h2 style="text-align:center">ChatBox</h2>	
            <br/>
            <br/><!-- Browse Jobs -->
   ...
   <p><b>Account ID: 1435337</b>
    ...
    <tr><td><p><p><span style="color:#0000ff"><span style="font-size:22px">All your chats with other users will be shown here.</span></span></p><p></td></tr>
    
<tr>
    <td>
<p>No body from your downline has replied you till date...</p>
</tr>
</table>
