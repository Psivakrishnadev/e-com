    ...
    <section class="section-padding bg-dark inner-header" style="background-image: url('assets/images/banner-image/4.jpg');height: 250px;" >
	  ...
	  <div class="page-content bg-white">
        ...
        <div class="content-block">
            <br/>
            <h2 style="text-align:center">My Unused PINs
</h2>	
            <br/>
            <br/><!-- Browse Jobs -->
...
<tr>
 <td width=100%>
 <table cellspacing=1 cellpadding=10 align=center width=100%>

<tr>
 <td class=heading>PIN
 <td class=heading align=center>Transfer
</tr>

<form method=POST onSubmit="return confirm('Are you sure that you want to transfer PINs to another User?');">
</form>
 </table>
</tr>
<tr>
 <td><div class='row'><div class='col-lg-12'><a href='#' class='pagi-btn'>1</a> </div></div></tr>
</table>
							</div>
							<!-- Modal -->
